...
<body>
  ...
  <?php 
    ...
    $query = mysqli_query($con,"SELECT * FROM user_details WHERE user_details.mobile_number=BINARY $mobile AND user_details.password='".$pwd."' ") or die(mysql_error());
    ...
    if($row = mysqli_fetch_array($query))
    {
      ...
      $query2 = mysqli_query($con," SELECT * from user_details,reservation where user_details.user_id=reservation.user_id AND  user_details.mobile_number=BINARY $mobile ORDER BY reservation.journey_date ASC") or die(mysql_error());
