        ...
        if ($status=='verified') 
        {
            ...
            echo"
                <div class=\"alert alert-danger alert-dismissible\">
                    ...
                    User has been already verified. No need to send verifcation notice.
                </div>
            ";
        } 
        else
        {
            echo"
                <div class=\"alert alert-success alert-dismissible\">
                    <button type=\"button\" class=\"close\" data-dismiss=\"alert\">&times;</button>
                    Verifcation code has been successfully sent to admin.
                </div>
            ";
            ...
            $message = "   <html>
                                <body>
                                    ...
                                    <p>Hi <b>$fname $lname</b>,<br>
                                        Your E-RRP account is <b style=\"color:tomato;\">not verified</b>. Please verify your account within next 72 hours. Otherwise, your account will be deleted from record.<br><br>
                                        <div>
                                            <b>Steps for Account Verifcation:</b>
                                            <ol>
                                                <li>Open E-RRP website.</li>
