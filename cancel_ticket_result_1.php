...
<body>
  <?php 
    ...
    $query1 = mysqli_query($con,"SELECT * FROM reservation WHERE reservation.pnr_number='".$pnr_number."' AND reservation.user_id='".$user_id."' ") or die(mysql_error());
        ...
        else
        {
            echo "
                  <div class=\"alert alert-success alert-dismissible\">
                      ...
                      <strong>You have successfully Cancelled Your Ticket.<i class=\"fa fa-smile-o\"></i>.
                  </div>
                ";
            $query3 = mysqli_query($con,"SELECT * FROM cancel_ticket WHERE cancel_ticket.pnr_number='".$pnr_number."' ") or die(mysql_error());
    ...
    {
        echo "<br><br>Error:" . $con->error;
    }

    $cdquery11="SELECT * FROM reservation where pnr_number='".$pnr_number."' ";
    $cdresult11=mysqli_query($con,$cdquery11);
    ...
    $cdresult21=mysqli_query($con,$cdquery21);
    $stations11=array();
    $xy=0;
    ...
    $cdresult1=mysqli_query($cnn,$cdquery1);
    ...
    $lname=$row[2];
    $eid=$row[3];
        $subject = "Ticket Cancellation on E-RRP";

        $sender = "From: E-RRP <bhargavs.20is@saividya.ac.in>\r\n";
        ...
        $message = "   <html>
                <body>
                    ...
                    <p>Hi <b>$fname $lname</b>,<br>
                        You have successfully cancelled ticket on E-RRP.Ticket details are given below:<br>
                        <br>
        ...
        $result123=mysqli_query($con,$query123) or die(mysql_error());
        $xy=1;
