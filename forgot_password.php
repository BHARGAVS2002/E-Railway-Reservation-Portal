...
<style>
  .login-form {
    ...
    box-shadow: 15px -15px 2px rgb(204 14 236);
        padding: 30px;
    }
    .login-form h2 {
        margin: 0 0 15px;
...
<body style="background-color: #c0ede1;">
    ...
    <?php
        ...
        {
            $eid=$_POST["emailid"];
            $query1=mysqli_query($con,"SELECT * FROM user_details WHERE user_details.emailid=BINARY '".$eid."' ") or die(mysql_error());
            ...
            else 
            {
                ...
                $lname= $row1["lname"];
		            ...
		            $subject = "E-RRP Account Password";
		                                ...
		                                <body>
        		                            <h1 style=\"color:green;text-align:center\"> Account Password</h1>
                		                       <p>Hi <b>$fname $lname</b>,<br>
                        		                    Your E-RRP account password is:<br> 
