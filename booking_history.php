...
<body style="background-image: url(images/irctc.jpg);background-repeat: no-repeat;background-size: cover;background-attachment: fixed;">
  <?php 
    ...
    if($row = mysqli_fetch_array($query))
    {
      ...
      if($temp6>0)
      {
            $subject = "Email Verification Code For E-RRP";
            $sender = "From: E-RRP<bhargavs.20is@saividya.ac.in>\r\n";
            $sender .= "MIME-Version: 1.0\r\n";
            $sender .="Content-Type: text/html; charset=ISO-8859-1\r\n";
            $message = "   <html>
                                <body>
                                    <h1 style=\"color:green;text-align:center\">Welcome to E-RRP &#128512;</h1>
           ...
           echo "
                  <div class=\"alert alert-danger alert-dismissible\">
                      ...
                      <strong>You did not verify your user id from admin</strong> <i class=\"far fa-frown\"></i>.....Enter the OTP and verify.<br>
                  </div>
                  <div class=\"text-center\">
      ...
      ";
      $_SESSION["id"]=$temp2;
      $query3 = mysqli_query($con," SELECT * from user_details where user_details.mobile_number=BINARY $mobile ") or die(mysql_error());
