...
<body>
    <?php 
        ...
        $nos=$_POST["nos"];
        $_SESSION["nos"] = "$nos";
        $query2 = mysqli_query($con,"SELECT available_seats FROM classseats WHERE classseats.journey_date= '$doj' AND classseats.train_number= $tno AND classseats.class_name= '$class' AND classseats.start_point= '".$_SESSION["sp"]."'  AND classseats.destination_point= '".$_SESSION["dp"]."'; ") or die(mysql_error());
