    ...
    <?php 
        ...
        if ($con->query($sql) === TRUE) 
        {
            echo "
                <div class=\"alert alert-sm alert-success alert-dismissible\">
                    ...
                    You have succefully booked ticket.....HAPPY JOURNEY.....
                </div>
            ";
        } 
        else 
        ...
        while ($stations11[$p1]!=$dp) 
        {
            ...
            while($y < $stations_count +1 )
            {
                ...
                $cdresult22=mysqli_query($con,$cdquery22);
                $y=$y+1;
            }
            $p1=$p1+1;
        }
        ...
        $lname=$row[2];
        $eid=$row[3];
        $subject = "Tatkal Ticket Booking Confirmation on E-RRP";
        ...
        $message = "   <html>
                <body>
                    ...
                    <p>Hi <b>$fname $lname</b>,<br>
                        You have successfully booked ticket on E-RRP.Ticket details are given below:<br>
                        <br>
