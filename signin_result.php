...
<body>
  <?php 
    ...
    $mobile=$_POST["mno"];
    $pwd=$_POST["password"];
    $query1=mysqli_query($con,"SELECT * FROM user_details WHERE user_details.mobile_number=$mobile ") or die(mysql_error());
    ...
    if($row = mysqli_fetch_array($query))
    {
      ...
      $_SESSION["id"]=$temp2;
    	...
    	$query2 = mysqli_query($con," SELECT * from user_details,reservation where user_details.user_id=reservation.user_id AND  user_details.mobile_number=$mobile ") or die(mysql_error());
