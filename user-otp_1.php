                    ...
                    <div class=\"row\">
                        <div class=\"col-md-4 offset-md-4 form pt-5 pb-3\">
                            <form action=\"user-otp_1.php\" method=\"POST\" autocomplete=\"off\">
                                ...
                                <p class=\"text-center text-danger\">Verification code has been sent to admin database.</p>
            ...
            if(mysqli_num_rows($code_res) > 0)
            {
                ...
                if($update_res)
                {
                    ...
                    <div class=\"alert alert-success alert-dismissible\">
                        ...
                        <strong>Hi!</strong> $fname $lname, your user id has been verified. <i class=\"fa fa-smile-o\"></i>.
                    </div>
