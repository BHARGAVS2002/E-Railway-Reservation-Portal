...
<body style="background-image: url(images/train1.jpg);background-repeat: no-repeat;background-size: cover;background-attachment: fixed;">
	<div align="center">
	      ...
	      die("Connection failed: " . $con->connect_error);
			...
			if (isset($_POST['submit']) && isset($_POST["uname"]) && isset($_POST["pwd"]))
			{
				$uname = $_POST["uname"];             
 				...
 				$query1=mysqli_query($con,"SELECT * FROM admin_details WHERE admin_details.username=BINARY '$uname' ") or die(mysql_error());
			    $query = mysqli_query($con,"SELECT * FROM admin_details WHERE admin_details.username= BINARY '$uname' AND admin_details.password= BINARY'".$pass."' ") or die(mysql_error());
    			...
    			else
				{
						...
						echo"
      					...
      					";
      					$query3 = mysqli_query($con," SELECT * from admin_details where admin_details.username=BINARY '$uname' AND admin_details.password=BINARY '$pass' ") or die(mysql_error());
