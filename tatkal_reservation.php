...
<body>
    <?php 
        ...
        $nos=$_POST["nos"];
        $_SESSION["nos"] = "$nos";
        $query2 = mysqli_query($con,"SELECT available_seats FROM tatkal_seats WHERE tatkal_seats.journey_date= '$doj' AND tatkal_seats.train_number= $tno AND tatkal_seats.class_name= '$class' AND tatkal_seats.start_point= '".$_SESSION["sp"]."'  AND tatkal_seats.destination_point= '".$_SESSION["dp"]."'; ") or die(mysql_error());
