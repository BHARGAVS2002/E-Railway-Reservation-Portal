...
<body >
  <?php 
    ...
    else
    {
      ...
      ";
      $result = mysqli_query($con,"SELECT  distinct t.train_number FROM train_details as t,tatkal_seats as c, train_schedule as s1,train_schedule as s2 where s1.train_number=t.train_number AND s2.train_number=t.train_number AND s1.station_name='".$sp."' AND s2.station_name='".$dp."' AND t.train_number=c.train_number AND c.start_point='".$sp."' AND c.destination_point='".$dp."' AND c.journey_date='".$doj."' ");
